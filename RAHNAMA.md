...
3. [اجرای خودکار با systemd](#اجرای-خودکار-با-systemd)
4. [تنظیمات محیط (.env)](#تنظیمات-محیط-env)
5. [کار آفلاین / بدون اینترنت](#کار-آفلاین--بدون-اینترنت)
6. [ورود و نقش‌های کاربری](#ورود-و-نقشهای-کاربری)
7. [پنل مدیریت](#پنل-مدیریت)
8. [پشتیبان‌گیری و بازیابی](#پشتیبانگیری-و-بازیابی)
9. [تنظیم LDAP / Active Directory](#تنظیم-ldap--active-directory)
10. [امنیت](#امنیت)
11. [عیب‌یابی](#عیبیابی)
...
```
/opt/food/CREDENTIALS.txt   ← فقط root — رمز DB، کلیدها، توکن سوپرادمین
/opt/food/.env              ← تنظیمات سامانه
```

> **حتماً** یک کپی از `CREDENTIALS.txt` در خزانه رمز سازمان نگه دارید.
