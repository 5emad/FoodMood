...
فقط یوزر و پسورد دیتابیس را می‌پرسد؛ بقیه (MongoDB، Nginx، کلیدهای رمزنگاری، سوپرادمین با رمز تصادفی) خودکار انجام می‌شود. اطلاعات ورود در `/opt/food/CREDENTIALS.txt` ذخیره می‌شود.
